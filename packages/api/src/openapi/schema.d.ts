...
export interface components {
  schemas: {
    ...
    /** @enum {string} */
    CollateralAssetFilter: "Any" | "Bitcoin" | "Arkade";
    Contract: {
      /**
       * Format: double
      ...
      fiat_loan_details_borrower?:
        | null
        | components["schemas"]["FiatLoanDetailsWrapperResponse"];
    ...
    ContractRequestSchema: {
      ...
      fiat_loan_details?:
        | null
        | components["schemas"]["FiatLoanDetailsWrapper"];
      id: string;
      /** Format: double */
      loan_amount: number;
      loan_type: components["schemas"]["LoanType"];
    ...
    FiatLoanDetails: {
      ...
      iban_transfer_details?:
        | null
        | components["schemas"]["IbanTransferDetails"];
      post_code: string;
      purpose_of_remittance: string;
      swift_transfer_details?:
        | null
        | components["schemas"]["SwiftTransferDetails"];
    };
    ...
    PakeVerifyResult:
      | components["schemas"]["PakeVerifyTotpResponse"]
      | components["schemas"]["PakeVerifyWithCookie"];
  ...
  get_all_available_loan_offers: {
    parameters: {
      query?: {
        ...
        /** @description Filter by collateral asset: Any, Bitcoin, or Arkade. Defaults to Bitcoin if not provided. */
        collateral_asset_type?: components["schemas"]["CollateralAssetFilter"];
