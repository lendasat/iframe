...
ALTER TABLE contracts ADD COLUMN interest DECIMAL;

UPDATE contracts
SET interest = (interest_rate / 100) * loan_amount * (duration_days / 360);

ALTER TABLE contracts ALTER COLUMN interest SET NOT NULL;

ALTER TYPE transaction_type RENAME VALUE 'InstallmentPaid' TO 'PrincipalRepaid';

DROP TABLE IF EXISTS installments;

DROP TYPE IF EXISTS installment_status;

ALTER TABLE loan_applications DROP COLUMN repayment_plan;
ALTER TABLE loan_offers DROP COLUMN repayment_plan;

DROP TYPE IF EXISTS repayment_plan;
