...
export function LiquidationPriceInfoLabel({
  children,
}: LiquidationPriceInfoLabelProps) {
  return (
    <AbbreviationExplanationInfo
      ...
      description={
        ...
        "Liquidation price equals loan-to-value (LTV) of 90%. If the Bitcoin price hits the liquidation price, even for only a couple of seconds, it is considered as a liquidation event."
      }
    >
