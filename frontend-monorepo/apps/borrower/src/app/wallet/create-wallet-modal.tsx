  ...
  return (
    <Modal show={show} onHide={handleClose} centered>
      <Box className="px-4 pt-7">
        <Box>
          <Heading as="h2" className="text-xl md:text-2xl lg:text-3xl font-semibold text-center text-font-dark mb-7">Create Contract Password</Heading>
        </Box>
        <Box className="mb-3">
            ...
            {(!error)
              ? (
                <Alert variant={'info'} className="flex items-start gap-2">
                  ...
                  <Text> Please enter a secret for your contracts. Keep this password safe. You will need it when unlocking your
                    funds.</Text>
                </Alert>
              )
              : ""}
