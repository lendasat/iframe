...
export default function HeaderNav() {
    ...
    return (
        <div className="items-center gap-3 hidden lg:flex">
            <Link to={'/history'} className="h-10 w-10 border hover:border-font-dark hover:text-black flex items-center justify-center rounded transition-colors ease-in duration-300">
                <IoNotifications className="text-xl text-font" />
            </Link>
            <Link to={'https://lendasat.notion.site'} className="h-10 w-10 border hover:border-font-dark hover:text-black flex items-center justify-center rounded transition-colors ease-in duration-300" target="_blank">
