...
import { ColumnFilter, ColumnFilterKey, ContractDetailsTable } from "./contract-details-table";

interface ContractListProps {
  contracts: Contract[];
}

function ContractList({ contracts: unfilteredContracts }: ContractListProps) {
