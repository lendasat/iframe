...
import type { BorrowerNotificationSettings } from "@frontend/http-client-borrower";
...
export function NotificationSettings() {
  ...
  const [localSettings, setLocalSettings] =
    useState<BorrowerNotificationSettings | null>(null);
  ...
  const handleSettingChange = (
    key: keyof BorrowerNotificationSettings,
    value: boolean,
  ) => {
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      checked={localSettings.new_loan_offer_telegram}
                      onCheckedChange={(checked) =>
                        handleSettingChange(
                    ...
                    />
                    <Label
                      htmlFor="new_loan_offer_telegram"
                      className="text-sm"
                    >
                      Telegram
                    </Label>
