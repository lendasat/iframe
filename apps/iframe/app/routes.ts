...
export default [
  ...
  layout("routes/app.tsx", [
    ...
    route("app/contracts/:contractId/repay", "routes/app/contracts.$contractId.repay.tsx"),
    route("app/contracts/:contractId/withdraw", "routes/app/contracts.$contractId.withdraw.tsx"),
